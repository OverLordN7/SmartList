...
interface ItemDao{
    ...
    @Query("UPDATE item_table SET name =:name,weight=:weight,price=:price, total =:total  WHERE id = CAST(:id AS BLOB)")
    fun updateItem(id: UUID,name: String, weight: Float, price: Float, total: Float)
